...
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'execute/inc_exec_controls.tpl', 38, false),)), $this); ?>
...
"/>
        ...
        <?php if ($this->_tpl_vars['args_save_type'] == 'bulk' && $this->_tpl_vars['args_execution_time_cfields'] != ''): ?>
          <tr><td colspan="2">
  					<div id="cfields_exec_time_tcversionid_<?php echo $this->_tpl_vars['args_tcversion_id']; ?>
