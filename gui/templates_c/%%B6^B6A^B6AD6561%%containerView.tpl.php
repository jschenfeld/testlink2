<?php /* Smarty version 2.6.26, created on 2011-03-19 09:06:06
         compiled from testcases/containerView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'testcases/containerView.tpl', 28, false),array('modifier', 'escape', 'testcases/containerView.tpl', 79, false),)), $this); ?>
<?php echo lang_get_smarty(array('var' => 'labels','s' => 'th_product_name,edit_testproject_basic_data,th_notes,test_suite,details,none,
             ...
             btn_new_testsuite, btn_reorder,btn_execute_automatic_testcases,
	           ...
	           testsuite_operations, testcase_operations'), $this);?>
...
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "inc_update.tpl", 'smarty_include_vars' => array('result' => $this->_tpl_vars['gui']->sqlResult,'item' => $this->_tpl_vars['gui']->level,'name' => $this->_tpl_vars['gui']->moddedItem['name'],'refresh' => $this->_tpl_vars['gui']->refreshTree)));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
...
<?php if ($this->_tpl_vars['gui']->level == 'testproject'): ?>
	...
	<h2><?php echo $this->_tpl_vars['labels']['testsuite_operations']; ?>
</h2>
...
" />
        ...
        <?php if ($this->_tpl_vars['gui']->canDoExport): ?>
...
" />
				...
				<fieldset class="groupBtn">
		<h2><?php echo $this->_tpl_vars['labels']['testcase_operations']; ?>
</h2>
