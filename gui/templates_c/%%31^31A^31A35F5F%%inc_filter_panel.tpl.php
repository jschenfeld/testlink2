<?php /* Smarty version 2.6.26, created on 2011-03-19 09:06:01
         compiled from inc_filter_panel.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'inc_filter_panel.tpl', 29, false),array('function', 'config_load', 'inc_filter_panel.tpl', 41, false),array('function', 'html_options', 'inc_filter_panel.tpl', 96, false),array('function', 'html_radios', 'inc_filter_panel.tpl', 217, false),)), $this); ?>
...
" />
			...
			<?php if ($this->_tpl_vars['control']->draw_export_testplan_button): ?>
				<tr>
		   			<td colspan="2">
...
"
         	         onclick="javascript: openExportTestPlan('export_testplan','<?php echo $this->_tpl_vars['session']['testprojectID']; ?>
',
         	                                                 '<?php echo $this->_tpl_vars['control']->settings['setting_testplan']['selected']; ?>
','<?php echo $this->_tpl_vars['platformID']; ?>
',
         	                                                 '<?php echo $this->_tpl_vars['control']->settings['setting_build']['selected']; ?>
');" />
            </td>
		  		</tr>
			<?php endif; ?>
