<?php /* Smarty version 2.6.26, created on 2012-03-23 07:05:07
         compiled from results/resultsByTesterPerBuild.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'results/resultsByTesterPerBuild.tpl', 13, false),array('modifier', 'escape', 'results/resultsByTesterPerBuild.tpl', 32, false),array('modifier', 'date_format', 'results/resultsByTesterPerBuild.tpl', 62, false),)), $this); ?>
 
<?php echo lang_get_smarty(array('var' => 'labels','s' => "generated_by_TestLink_on,hlp_results_by_tester_per_build_table,show_closed_builds_btn"), $this);?>
...
<?php if ($this->_tpl_vars['gui']->warning_message == ''): ?>
...
?>
	...
	<br />
		<p class="italic"><?php echo $this->_tpl_vars['labels']['hlp_results_by_tester_per_build_table']; ?>
</p>
	<br />
...
<?php else: ?>
    ...
    <?php echo $this->_tpl_vars['gui']->warning_message; ?>
