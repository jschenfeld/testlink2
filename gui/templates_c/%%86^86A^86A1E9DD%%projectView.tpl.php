<?php /* Smarty version 2.6.26, created on 2011-03-19 09:05:48
         compiled from project/projectView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'basename', 'project/projectView.tpl', 16, false),array('modifier', 'replace', 'project/projectView.tpl', 16, false),array('modifier', 'escape', 'project/projectView.tpl', 77, false),array('modifier', 'strip_tags', 'project/projectView.tpl', 85, false),array('modifier', 'strip', 'project/projectView.tpl', 85, false),array('modifier', 'truncate', 'project/projectView.tpl', 85, false),array('function', 'config_load', 'project/projectView.tpl', 17, false),array('function', 'lang_get', 'project/projectView.tpl', 25, false),)), $this); ?>
...
"><?php echo $this->_tpl_vars['labels']['th_requirement_feature']; ?>
			...
			<th class="icon_cell"><?php echo $this->_tpl_vars['labels']['public']; ?>
</th>
...
"/>
			...
			<td class="clickable_icon">
				<?php if ($this->_tpl_vars['testproject']['opt']->requirementsEnabled): ?>
  					<img style="border:none" title="<?php echo $this->_tpl_vars['labels']['testproject_alt_requirement_feature']; ?>
"
...
"/>
			...
			<td class="clickable_icon">
				<?php if ($this->_tpl_vars['testproject']['active']): ?>
  					<img style="border:none" title="<?php echo $this->_tpl_vars['labels']['testproject_alt_active']; ?>
"
...
"/>
			...
			<td class="clickable_icon">
				<?php if ($this->_tpl_vars['testproject']['is_public']): ?>
