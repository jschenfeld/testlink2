<?php /* Smarty version 2.6.26, created on 2012-03-12 15:37:23
         compiled from execute/execSetResults.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'execute/execSetResults.tpl', 33, false),array('modifier', 'basename', 'execute/execSetResults.tpl', 57, false),array('modifier', 'replace', 'execute/execSetResults.tpl', 57, false),array('function', 'lang_get', 'execute/execSetResults.tpl', 35, false),array('function', 'config_load', 'execute/execSetResults.tpl', 58, false),array('function', 'cycle', 'execute/execSetResults.tpl', 430, false),array('function', 'html_options', 'execute/execSetResults.tpl', 441, false),)), $this); ?>
...
<?php echo lang_get_smarty(array('var' => 'labels','s' => 'edit_notes,build_is_closed,test_cases_cannot_be_executed,test_exec_notes,test_exec_result,
	...
	preconditions,platform,platform_description,exec_not_run_result_note,remoteExecFeeback'), $this);?>
...
<?php $this->assign('exportAction', "lib/execute/execExport.php?tplan_id="); ?>
...
";
var warning_nothing_will_be_saved="<?php echo ((is_array($_tmp=$this->_tpl_vars['labels']['warning_nothing_will_be_saved'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
";
<?php echo '
...
" />
  ...
  <?php if ($this->_tpl_vars['cfg']->exec_cfg->show_testsuite_contents && $this->_tpl_vars['gui']->can_use_bulk_op): ?>
      ...
      <div>
      <br />
      <input type="button" id="do_export_testcases" name="do_export_testcases"  value="<?php echo $this->_tpl_vars['labels']['btn_export_testcases']; ?>
"
    	         onclick="javascript: openExportTestCases('export_testcases',<?php echo $this->_tpl_vars['gui']->node_id; ?>
...
,<?php echo $this->_tpl_vars['gui']->platform_id; ?>
,
    	                                                  '<?php echo $this->_tpl_vars['gui']->tcversionSet; ?>
');" />
...
">
  ...
  <?php else: ?>
	...
	<?php if ($this->_tpl_vars['tlCfg']->exec_cfg->enable_test_automation && $this->_tpl_vars['gui']->remoteExecFeedback != ''): ?>
		<b><?php echo $this->_tpl_vars['labels']['remoteExecFeeback']; ?>
</b>
		<?php if ($this->_tpl_vars['gui']->remoteExecFeedback['system'] == ''): ?>
			<br><?php echo ((is_array($_tmp=$this->_tpl_vars['gui']->remoteExecFeedback['statusVerbose'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>

			<br><?php echo ((is_array($_tmp=$this->_tpl_vars['gui']->remoteExecFeedback['notes'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>

			<?php if ($this->_tpl_vars['gui']->remoteExecFeedback['status'] == ''): ?>	
				<br><?php echo ((is_array($_tmp=$this->_tpl_vars['gui']->remoteExecFeedback['scheduled'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>

				<br><?php echo ((is_array($_tmp=$this->_tpl_vars['gui']->remoteExecFeedback['timestamp'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>

			<?php endif; ?>	
		<?php else: ?>
			<br><?php echo ((is_array($_tmp=$this->_tpl_vars['gui']->remoteExecFeedback['system']['msg'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
