<?php /* Smarty version 2.6.26, created on 2012-03-06 10:13:00
         compiled from testcases/tcEdit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'testcases/tcEdit.tpl', 20, false),array('function', 'config_load', 'testcases/tcEdit.tpl', 100, false),array('modifier', 'escape', 'testcases/tcEdit.tpl', 45, false),)), $this); ?>
...
<form method="post" action="lib/testcases/tcEdit.php" name="tc_edit"
	...
	<input type="hidden" name="testsuite_id" id="testsuite_id" value="<?php echo $this->_tpl_vars['gui']->tc['testsuite_id']; ?>
" />
...
" />
		...
		<input id="do_update" type="submit" name="do_update" 
		       onclick="show_modified_warning=false; doAction.value='doUpdate'" value="<?php echo $this->_tpl_vars['labels']['btn_save']; ?>
" />
