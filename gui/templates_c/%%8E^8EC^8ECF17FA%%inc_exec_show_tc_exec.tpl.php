...
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'execute/inc_exec_show_tc_exec.tpl', 46, false),array('function', 'localize_timestamp', 'execute/inc_exec_show_tc_exec.tpl', 132, false),array('function', 'localize_tc_status', 'execute/inc_exec_show_tc_exec.tpl', 145, false),array('function', 'cycle', 'execute/inc_exec_show_tc_exec.tpl', 205, false),array('modifier', 'escape', 'execute/inc_exec_show_tc_exec.tpl', 95, false),array('modifier', 'replace', 'execute/inc_exec_show_tc_exec.tpl', 139, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?>
                ...
                <?php if (isset ( $this->_tpl_vars['gui']->bugs[$this->_tpl_vars['execID']] )): ?>
		<tr style="background-color: <?php echo $this->_tpl_vars['bg_color']; ?>
">
   			<td colspan="<?php echo $this->_tpl_vars['my_colspan']; ?>
">
