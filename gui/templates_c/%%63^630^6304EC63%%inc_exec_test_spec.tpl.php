...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'execute/inc_exec_test_spec.tpl', 37, false),)), $this); ?>
...
&nbsp;
		  	 <a href="javascript:openLinkedReqWindow(<?php echo $this->_tpl_vars['req_elem']['id']; ?>
)"  
		  	    title="<?php echo $this->_tpl_vars['args_labels']['click_to_open']; ?>
">
...
"><?php echo $this->_tpl_vars['args_labels']['execution_type']; ?>
		...
		<tr>
			        	<td colspan="<?php echo $this->_tpl_vars['tableColspan']; ?>
"> <?php echo $this->_tpl_vars['args_design_time_cf'][$this->_tpl_vars['testcase_id']]['before_steps_results']; ?>
</td>
		</tr>
		<?php endif; ?>
...
$this->_smarty_include(array('smarty_include_tpl_file' => "testcases/inc_steps.tpl", 'smarty_include_vars' => array('layout' => $this->_tpl_vars['args_cfg']->exec_cfg->steps_results_layout,'edit_enabled' => false,'steps' => $this->_tpl_vars['args_tc_exec']['steps'])));
