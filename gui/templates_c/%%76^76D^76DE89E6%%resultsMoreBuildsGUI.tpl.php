<?php /* Smarty version 2.6.26, created on 2012-03-23 07:05:17
         compiled from results/resultsMoreBuildsGUI.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'results/resultsMoreBuildsGUI.tpl', 18, false),array('function', 'config_load', 'results/resultsMoreBuildsGUI.tpl', 26, false),array('function', 'html_select_time', 'results/resultsMoreBuildsGUI.tpl', 138, false),array('modifier', 'basename', 'results/resultsMoreBuildsGUI.tpl', 25, false),array('modifier', 'replace', 'results/resultsMoreBuildsGUI.tpl', 25, false),array('modifier', 'escape', 'results/resultsMoreBuildsGUI.tpl', 81, false),)), $this); ?>
<?php echo lang_get_smarty(array('var' => 'labels','s' => 'enter_start_time,enter_end_time,date,hour,Yes,submit_query,
			   ...
			   search_in_notes,executor,No,query_metrics_report,show_calender'), $this);?>
...
<?php if ($this->_tpl_vars['gui']->platforms->qty > $this->_config[0]['vars']['PLATFORMS_COMBO_NUM_ITEMS']): ?>
  <?php $this->assign('platform_qty', $this->_config[0]['vars']['PLATFORMS_COMBO_NUM_ITEMS']); ?>
<?php else: ?>
  <?php $this->assign('platform_qty', $this->_tpl_vars['gui']->platforms->qty); ?>
<?php endif; ?>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['executorid'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
  		...
  		<tr>
				<th><?php echo $this->_tpl_vars['labels']['search_in_notes']; ?>
                        ...
                        <?php if ($this->_tpl_vars['platform_qty'] > 0): ?>
			        <th><?php echo $this->_tpl_vars['labels']['select_platforms_header']; ?>
</th>
                        <?php else: ?>
                                <th>&nbsp;</th>
                        <?php endif; ?>
			...
			<tr>
				<td>
					<input type="text" name="search_notes_string"/>
                        ...
                        <td>
                        <?php if ($this->_tpl_vars['platform_qty'] > 0): ?>
				<select name="platform[]" size="<?php echo $this->_tpl_vars['platform_qty']; ?>
" multiple="multiple">
					<?php $_from = $this->_tpl_vars['gui']->platforms->items; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['row'] => $this->_tpl_vars['platformid']):
?>
						<option value="<?php echo $this->_tpl_vars['gui']->platforms->items[$this->_tpl_vars['row']]['id']; ?>
" selected="selected"><?php echo ((is_array($_tmp=$this->_tpl_vars['gui']->platforms->items[$this->_tpl_vars['row']]['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</option>
					<?php endforeach; endif; unset($_from); ?>
				</select>
                        <?php endif; ?>
