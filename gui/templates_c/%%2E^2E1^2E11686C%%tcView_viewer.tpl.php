<?php /* Smarty version 2.6.26, created on 2011-03-19 09:07:17
         compiled from testcases/tcView_viewer.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'testcases/tcView_viewer.tpl', 39, false),array('modifier', 'escape', 'testcases/tcView_viewer.tpl', 80, false),)), $this); ?>
...
<?php $this->assign('printTestCaseAction', "lib/testcases/tcPrint.php?show_mode=".($this->_tpl_vars['showMode'])); ?>
...
'" />
  ...
  <?php endif; ?>
	...
	<span>
	<form style="display: inline;" id="tcexport" name="tcexport" method="post" action="<?php echo $this->_tpl_vars['exportTestCaseAction']; ?>
" >
		<input type="hidden" name="testcase_id" value="<?php echo $this->_tpl_vars['args_testcase']['testcase_id']; ?>
" />
		<input type="hidden" name="tcversion_id" value="<?php echo $this->_tpl_vars['args_testcase']['id']; ?>
...
" />
	...
	<form style="display: inline;" id="tcprint" name="tcprint" method="post" action="" >
		<input type="button" name="tcPrinterFriendly" style="margin-left: 3px;" value="<?php echo $this->_tpl_vars['tcView_viewer_labels']['btn_print_view']; ?>
" 
		       onclick="javascript:openPrintPreview('tc',<?php echo $this->_tpl_vars['args_testcase']['testcase_id']; ?>
,<?php echo $this->_tpl_vars['args_testcase']['id']; ?>
,null,
			                                          '<?php echo $this->_tpl_vars['printTestCaseAction']; ?>
');"/>
	</form>
	</span>
  </div> <br/><br/>
  ...
  <?php if ($this->_tpl_vars['args_testcase']['active'] == 0): ?>
    <div class="messages" align="center"><?php echo $this->_tpl_vars['tcView_viewer_labels']['tcversion_is_inactive_msg']; ?>
</div>
  <?php endif; ?>
...
>
 ...
 <?php echo @TITLE_SEP; ?>
		...
		<?php if (isset ( $this->_tpl_vars['gui']->execution_types[$this->_tpl_vars['args_testcase']['execution_type']] )): ?>
		  <?php echo $this->_tpl_vars['gui']->execution_types[$this->_tpl_vars['args_testcase']['execution_type']]; ?>

		<?php else: ?>
		  Unknown execution type code: <?php echo $this->_tpl_vars['args_testcase']['execution_type']; ?>
...
?>
      					      					<span onclick="javascript: openLinkedReqWindow(<?php echo $this->_tpl_vars['args_reqs'][$this->_sections['item']['index']]['id']; ?>
);"
