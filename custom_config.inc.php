 ...
 */
$g_smtp_host        = 'localhost';  # '[smtp_host_not_configured]';  # SMTP server MUST BE configured

# Configure using custom_config.inc.php
$g_tl_admin_email     = 'admin@gizur.com'; # '[testlink_sysadmin_email_not_configured]'; # for problem/error notification
$g_from_email         = 'admin@gizur.com'; # '[from_email_not_configured]';  # email sender
$g_return_path_email  = 'admin@gizur.com'; # '[return_path_email_not_configured]';
